...
CREATE TABLE "public"."real_estates" (
    "id" SERIAL NOT NULL,
    "user_address_id" INTEGER NOT NULL,
    "real_estate_data" TEXT NOT NULL,
    "updated_at" TIMESTAMPTZ(6) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "tax_certs_user_address_id_key" ON "public"."tax_certs"("user_address_id");

-- CreateIndex
CREATE UNIQUE INDEX "addresses_coordinate_dong_ho" ON "public"."addresses"("latitude", "longitude", "dong", "ho");

-- CreateIndex
CREATE UNIQUE INDEX "real_estates_user_address_id_key" ON "public"."real_estates"("user_address_id");
