...
export const REAL_ESTATE_TRANSACTION_API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    // 아파트 전월세 실거래가
    APARTMENT_RENT: '/getRTMSDataSvcAptRent',
    // 단독/다가구 전월세 실거래가
  ...
  get APARTMENT_RENT_FULL_URL() {
    return `${this.BASE_URL}${this.ENDPOINTS.APARTMENT_RENT}`;
  },
...
export const API_ENDPOINTS = {
  ...
  REAL_ESTATE_APARTMENT_RENT: REAL_ESTATE_TRANSACTION_API_CONFIG.APARTMENT_RENT_FULL_URL,
