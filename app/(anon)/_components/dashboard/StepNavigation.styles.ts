export const styles = {
  ...
  stepItem: "flex flex-col items-start p-3 transition-all text-left bg-brand-white",
  activeStep: "!bg-brand-light-gray border-l-4 border-brand font-bold text-brand-dark-blue",
