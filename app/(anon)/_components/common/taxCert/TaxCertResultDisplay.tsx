...
export default function TaxCertResultDisplay() {
  ...
  console.log(userAddressNickname);
      ...
      <div className={styles.container}>
        <div className={styles.formContainer}>
          <div className="text-center py-12 text-brand-dark-gray">
            <p className="text-brand-dark-gray">❌ {errorMessage}</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className={styles.container}>
      <div className={styles.formContainer}>
        ...
        <div className={styles.tableContainer}>
         ...
         {data.resOriGinalData1 && (
           <div className={styles.tableContainer}>
             <h4 className={styles.tableTitle}>납세증명서 PDF</h4>
             <PdfViewer
