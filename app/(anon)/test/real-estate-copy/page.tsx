...
export default function RealEstateCopyTestPage() {
  ...
  const [realEstateCopy, setRealEstateCopy] = useState<RealEstateCopy | null>(
    null
  );
  ...
  const handleGetRealEstateCopy = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `/api/real-estate-copy?userAddressNickname=${userAddressNickname}`
      );
        ...
        <div className={styles.results}>
          ...
          <div className={styles.copyItem}>
            ...
            <div className={styles.copyInfo}>
                ...
                <div className={styles.infoItem}>
                  ...
                  <span>
                    {realEstateCopy.updatedAt
                      ? new Date(realEstateCopy.updatedAt).toLocaleString()
                      : 'N/A'}
                  </span>
                </div>
              </div>
              ...
              {(() => {
                const copyInfo = extractRealEstateInfo(
                  realEstateCopy.realEstateJson
                );
                return (
                  <>
                    <div className={styles.infoItem}>
