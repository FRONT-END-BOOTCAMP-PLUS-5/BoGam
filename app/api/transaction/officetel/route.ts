...
export async function GET(request: NextRequest) {
  try {
    ...
    const response: GetRealEstateTransactionResponse = await useCase.getOfficetelTradeTransactions(requestData);
    ...
    console.error('오피스텔 매매 실거래가 조회 API 에러:', error);
